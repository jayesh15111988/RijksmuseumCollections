...
final class APIRouteTests: XCTestCase {
    ...
    func testThatAPIRouteCorrectlySetsURLRequestBasedOnPassedCase() {
        ...
        XCTAssertEqual(urlRequest.url?.absoluteString, "https://www.rijksmuseum.nl/api/nl/collection?key=0fiuZFh4&q=Picasso&p=1", "The remote URL associated with apiRoute for search keyword Picasso and pageNumber 1 is incorrect")
    }
}
